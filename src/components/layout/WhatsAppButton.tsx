  ...
  return (
    <div className={cn(
      ...
      <Button 
        ...
        className="w-16 h-16 rounded-full bg-[#25D366] hover:bg-[#20ba59] text-white shadow-2xl flex items-center justify-center p-0 transition-all hover:scale-110 active:scale-95 animate-whatsapp-glow border-none"
      >
        <WhatsAppIcon />
      </Button>
    </div>
